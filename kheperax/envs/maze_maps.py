...
register_target_maze(
    ...
    segments=[
        ...
        Segment(Pos(0.14, 0.45), Pos(0., 0.65)),  # Obstacle top left
        Segment(Pos(0.25, 0.75), Pos(0., 0.8)),  # Wall to target
        Segment(Pos(0.25, 0.75), Pos(0.66, 0.875)),  # Wall top right
        Segment(Pos(0.355, 0.), Pos(0.525, 0.185)),  # Obstacle bottom right
        Segment(Pos(0.25, 0.5), Pos(0.75, 0.215)),  # Funnel bottom
        Segment(Pos(1., 0.25), Pos(0.435, 0.55)),  # Funnel top
        # For quad
        Segment(Pos(0., 0.8), Pos(0., 1.0)),  # Wall top left
        Segment(Pos(0.355, 0.), Pos(1.0, 0.0)),  # Wall bottom right
    ],
    target_pos=(0.15, 0.9),
    target_radius=0.05,
)
...
register_target_maze(
    ...
    segments=[
        ...
        # For quad
        Segment(Pos(0., y_bottom), Pos(0., 1.)),  # vertical left
    ],
    target_pos=(0.9, 0.9),
    target_radius=0.05,
)
